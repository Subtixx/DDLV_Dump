...
namespace Mdl.Ui
{
	...
	public class ShopProductGroupGem : ShopProductGroupDefault
	{
		...
		[Cpp2IlInjected.Address(RVA = "0x142CC20", Offset = "0x142B620", VA = "0x18142CC20", Slot = "5")]
		public override void RefreshDisplay()
		{
			...
			if (enumerator != null)
			{
				...
				ShopProductItemGem shopProductItemGem = default(ShopProductItemGem);
				shopProductItemGem.RefreshDisplay();
				num++;
			}
