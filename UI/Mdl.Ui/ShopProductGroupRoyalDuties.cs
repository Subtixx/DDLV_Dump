...
namespace Mdl.Ui
{
	...
	public class ShopProductGroupRoyalDuties : ShopProductGroupDefault
	{
		...
		[Cpp2IlInjected.Address(RVA = "0x142D010", Offset = "0x142BA10", VA = "0x18142D010", Slot = "5")]
		public override void RefreshDisplay()
		{
			...
			if (enumerator != null)
			{
				...
				ShopProductItemRoyalDuties shopProductItemRoyalDuties = default(ShopProductItemRoyalDuties);
				shopProductItemRoyalDuties.RefreshDisplay();
				num++;
			}
		...
		public ShopProductGroupRoyalDuties()
		{
		}
	}
}
