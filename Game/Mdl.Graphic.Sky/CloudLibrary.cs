...
namespace Mdl.Graphic.Sky
{
	...
	[CreateAssetMenu]
	public class CloudLibrary : ScriptableObject
	{
		...
		public virtual void CloudUpdate(GameObject parent, float time, Camera camera)
		{
			throw new Cpp2IlInjected.AnalysisFailedException("CPP2IL failed to recover any usable IL for this method.");
		}
		...
		public virtual void Draw(CommandBuffer cmd, Matrix4x4 mat)
		{
			throw new Cpp2IlInjected.AnalysisFailedException("CPP2IL failed to recover any usable IL for this method.");
		}
